...
from ErzaScarlet.modules.helper_funcs.filters import CustomFilters
from ErzaScarlet.modules.helper_funcs.alternate import typing_action
from ErzaScarlet import dispatcher, DRAGONS, DEMONS, LOGGER
from ErzaScarlet.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler

import ErzaScarlet.modules.helper_funcs.fun_strings as fun
...
def sanitize(update: Update, context: CallbackContext):
    ...
    reply_animation(
        random.choice(fun.SANITIZE_GIFS), caption=f'*Sanitizes {name}*')
...
Erza will reply random strings accordingly when these words are used!
